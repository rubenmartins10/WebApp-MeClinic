...
class ConsultasController {
  ...
  static async create(req, res, next) {
    try {
      const { paciente_id, data_consulta, hora_consulta, motivo, procedimento_id, diagnostico, tratamento } = req.body;
      ...
      const hasConflict = await Consulta.hasConflict(data_consulta, hora_consulta);
      if (hasConflict) {
  ...
  static async update(req, res, next) {
    try {
      ...
      if (req.body.data_consulta || req.body.hora_consulta) {
        const data = req.body.data_consulta || consulta.data_consulta;
        const hora = req.body.hora_consulta || consulta.hora_consulta;
